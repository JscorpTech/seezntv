    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster_desktop', models.ImageField(max_length=255, upload_to='poster/', verbose_name='poster_desktop')),
                ('poster_mobile', models.ImageField(max_length=255, upload_to='poster/', verbose_name='poster_mobile')),
                ('poster_card', models.ImageField(max_length=255, upload_to='poster/', verbose_name='poster_card')),
                ('poster_video', models.FileField(max_length=255, upload_to='poster/', verbose_name='poster_video')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.commentmodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(max_length=255, upload_to='cadr/', verbose_name='image')),
                ('content', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cadrs', to='api.contentmodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('content', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.contentmodel', verbose_name='content')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skip_end_time', models.DurationField(blank=True, null=True, verbose_name='skip_end_time')),
                ('position', models.PositiveIntegerField(blank=True, null=True, verbose_name='position')),
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='api.contentmodel', verbose_name='content')),
            ],
            options={
