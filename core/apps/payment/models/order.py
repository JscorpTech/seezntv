...
from ..choices import PaymentTypeChoice, OrderStatusChoice


class OrderModel(AbstractBaseModel):
    amount = models.BigIntegerField(_("amount"))
    status = models.CharField(_("status"), choices=OrderStatusChoice.choices, default=OrderStatusChoice.CREATED)
    ...
    file = models.FileField(_("file"), upload_to="file/", null=True, blank=True)
